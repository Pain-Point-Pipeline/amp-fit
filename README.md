...
- [ ] Pass 6, decided 2026-09-19, launch line: `amp-fit pass. n=6 repo=iamdanielkitchen/food-bridge-app`, on a fresh thread (no `request=`: the first pass to load the `frozen:` slot in the `Noticed:` line).
