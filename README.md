...
- [ ] Pass 4, decided 2026-09-19, launch line: `amp-fit pass. n=4 repo=iamdanielkitchen/food-bridge-app`, on a fresh thread (no `request=`: the first pass to load the `Noticed:` template).
