...
- [x] Passes 1-6, all on `iamdanielkitchen/food-bridge-app` and all merged. A pass is recorded as a row in [LEDGER.md](LEDGER.md) — its date, request, runtime, thread and outcome — not as a line here.
