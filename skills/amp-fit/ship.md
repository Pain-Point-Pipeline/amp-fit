Deliver substantive changes as pull requests only. Work on a fresh amp-fit/<n> branch. Never commit, write, push or merge the default branch.
Inspect the diff, run the relevant verification, commit and push only the work branch, and create or update the corresponding PR against the default branch. Do not merge.
